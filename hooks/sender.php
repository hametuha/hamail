...
add_action( 'add_meta_boxes', function ( $post_type ) {
	...
	// Recipients
	add_meta_box( 'hamail-recipients', __( 'Recipients', 'hamail' ), 'hamail_recipients_meta_box', 'hamail', 'normal', 'high' );
	// Sending status
	add_meta_box( 'hamail-status', __( 'Sending Status', 'hamail' ), 'hamail_status_meta_box', 'hamail', 'side', 'low' );
} );
